$(function () {
	...
	window.addEventListener("message", function (event) {
		...
		if (event.data.action == "HungerUpdate") {
			...
			$(".hunger").css(
				"background-image",
				`linear-gradient(#d5993d ` + Hunger + `%, transparent ` + (Hunger - 100) + `%, transparent)`
			);
		}
		if (event.data.action == "ThirstUpdate") {
			...
			$(".thirst").css(
				"background-image",
				`linear-gradient(#4a79af ` + Thirst + `%, transparent ` + (Thirst - 100) + `%, transparent)`
			);
		}
		...
		if (event.data.action == "StatusUpdate") {
			...
			$(".health").css(
				"background-image",
				`linear-gradient(#31a372 ` + Health + `%, transparent ` + (Health - 100) + `%, transparent)`
			);
			$(".armour").css(
				"background-image",
				`linear-gradient(#3989ff ` + Armour + `%, transparent ` + (Armour - 100) + `%, transparent)`
			);
			$(".stamina").css(
				"background-image",
				`linear-gradient(#485a78 ` + Stamina + `%, transparent ` + (Stamina - 100) + `%, transparent)`
			);
			$(".oxygen").css(
				"background-image",
				`linear-gradient(#800 ` + Oxygen + `%, transparent ` + (Oxygen - 100) + `%, transparent)`
			);
		}
